...
%prep
%setup -q -n messagelib-21.08.2
cd %{_builddir}/messagelib-21.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634438689
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/messagelib-21.08.2/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/messagelib/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/messagelib-21.08.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/messagelib/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/messagelib-21.08.2/LICENSES/BSL-1.0.txt %{buildroot}/usr/share/package-licenses/messagelib/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
cp %{_builddir}/messagelib-21.08.2/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/messagelib/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/messagelib-21.08.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/messagelib/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/messagelib-21.08.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/messagelib/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/messagelib-21.08.2/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/messagelib/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/messagelib-21.08.2/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/messagelib/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/messagelib-21.08.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/messagelib/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/messagelib-21.08.2/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/messagelib/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/messagelib-21.08.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/messagelib/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/messagelib-21.08.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/messagelib/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/messagelib-21.08.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/messagelib/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/messagelib-21.08.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/messagelib/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/messagelib-21.08.2/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/messagelib/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5MessageComposer.so.5.18.2
/usr/lib64/libKF5MessageCore.so.5
/usr/lib64/libKF5MessageCore.so.5.18.2
/usr/lib64/libKF5MessageList.so.5
/usr/lib64/libKF5MessageList.so.5.18.2
/usr/lib64/libKF5MessageViewer.so.5
/usr/lib64/libKF5MessageViewer.so.5.18.2
/usr/lib64/libKF5MimeTreeParser.so.5
/usr/lib64/libKF5MimeTreeParser.so.5.18.2
/usr/lib64/libKF5TemplateParser.so.5
/usr/lib64/libKF5TemplateParser.so.5.18.2
/usr/lib64/libKF5WebEngineViewer.so.5
/usr/lib64/libKF5WebEngineViewer.so.5.18.2
